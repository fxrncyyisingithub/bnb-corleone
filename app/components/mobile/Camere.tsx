...
export default function MobileCamere() {
  return (
    <div className="flex-grow pb-16 px-margin-mobile max-w-container-max mx-auto w-full pt-10">
      <div className="mb-12">
      ...
      <div className="flex flex-col gap-12">
        {rooms.map((room) => (
          <article
            key={room.id}
            className="flex flex-col group cursor-pointer border-b border-outline-variant pb-8 last:border-0 last:pb-0"
          >
